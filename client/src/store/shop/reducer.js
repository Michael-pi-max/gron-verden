...
const reducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case ShopActionTypes.IDENTIFYPLANT_CREATE_START:
      return {
        ...state,
        createShopLoading: true,
        createShopError: null,
      };
    case ShopActionTypes.IDENTIFYPLANT_CREATE_SUCCESS:
      return {
        ...state,
        createShopLoading: false,
        createShopSuccess: true,
    ...
    case ShopActionTypes.IDENTIFYPLANT_CREATE_ERROR:
      return {
        ...state,
        createShopLoading: false,
        createShopError: action.payload.error,
      };
    case ShopActionTypes.CLEAR_IDENTIFYPLANT_CREATE_SUCCESS:
      return {
        ...state,
        createShopSuccess: false,
      };
